...
const MainPage = () => {
  ...
  return (
    <div className="flex justify-center">
      <div className="px-5 lg:pl-5 lg:px-0 flex flex-col w-full gap-y-2 sm:gap-5 md:gap-0 my-2 sm:flex-row pb-16 sm:fixed sm:max-w-[600px] md:max-w-[891px] lg:max-w-[1150px] xl:max-w-[1400px] xxl:max-w-[2500px]">
        <>{console.log(datas)}</>
        ...
        <div className="sm:w-1/2 md:w-2/3 lg:w-3/4 md:pl-[7px] lg:pl-[0px] xl:w-4/5 max-w-">
